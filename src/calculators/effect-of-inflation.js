...
export default class EffectOfInflation extends Component {
  render() {
          ...
          <div className="calculatorPage-result">
            ...
            {isFormValid && (
              <span className="calculatorPage-summaryText">
                You need {formatOutputDollars(startValue.value)} in the year{' '}
                {endYear.value} to buy the same amount of stuff that you could
                buy with {result} in the year {startYear.value}.
              </span>
            )}
          </div>
        </div>
